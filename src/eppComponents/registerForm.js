    ...
    <div className="container-fluid py-4" style={{ backgroundColor: "#F5B70A" }}>
      <div className="text-center mb-3">
        <h5 className="fw-bold text-danger">
          ...
          <span className="fw-bold text-decoration-none" style={{Color: "#910B3D"}}>-</span>Find Your Perfect Partner From Thousands Of Genuine Matches
        </h5>
      </div>
      ...
      <div className="card border-0 shadow-sm p-4 mx-auto" style={{ maxWidth: "1000px", borderRadius: "10px" }}>
        ...
        <div className="d-flex justify-content mb-4">
          ...
          <button className="btn text-white fw-semibold px-4" style={{backgroundColor:"#910B3D"}}>Free Registration</button>
        </div>
        ...
        <form className="row g-3 justify-content align-items-end">
          ...
          <div className="col-md-3 text-center">
            <button className="btn text-white w-100 fw-semibold" type="submit" style={{backgroundColor:"#910B3D"}}>
